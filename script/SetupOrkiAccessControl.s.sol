...
import {DeployOrkiBase} from "./DeployOrkiBase.sol";
...
function setupAccessControl(
    address deployer,
    DeployOrkiBase.DeploymentResult memory deployed,
...
function setupAccessControlUpgradeableContracts(DeployOrkiBase.DeploymentResult memory deployed) {
