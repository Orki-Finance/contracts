...
contract DeployOrkiLocal is DeployOrkiBase {
    bytes32 SALT;
    ...
    function run() external virtual {
        ...
        troveManagerParamsArray[2] =
            TroveManagerParams(150e16, 120e16, 110e16, 10e16, 5e16, 10e16, 500e18, 72e16, _1pct / 2, RSWETH_BORROW_CAP); // rswETH
        troveManagerParamsArray[3] =
            TroveManagerParams(150e16, 120e16, 110e16, 10e16, 5e16, 10e16, 500e18, 72e16, _1pct / 2, EZETH_BORROW_CAP); // ezETH
        // troveManagerParamsArray[4] =
        //     TroveManagerParams(150e16, 120e16, 110e16, 10e16, 5e16, 10e16, 500e18, 72e16, _1pct / 2, RSETH_BORROW_CAP); // rsETH
        // troveManagerParamsArray[5] =
        //     TroveManagerParams(150e16, 120e16, 110e16, 10e16, 5e16, 10e16, 500e18, 72e16, _1pct / 2, SWETH_BORROW_CAP); // swETH
        troveManagerParamsArray[4] =
            TroveManagerParams(150e16, 120e16, 110e16, 10e16, 5e16, 10e16, 500e18, 72e16, _1pct / 2, SWBTC_BORROW_CAP); // swBTC
        ...
        // collNames[0] = "Wrapped eETH";
        // collSymbols[0] = "weETH";
        collNames[0] = "rswETH";
        collSymbols[0] = "rswETH";
        // collNames[2] = "Renzo Restaked ETH";
        // collSymbols[2] = "ezETH";
        // collNames[3] = "KelpDao Restaked ETH";
        // collSymbols[3] = "rsETH";
        collNames[1] = "swETH";
        collSymbols[1] = "swETH";
        collNames[2] = "SWELL Governance Token";
        collSymbols[2] = "SWELL";
        collNames[3] = "swBTC";
        collSymbols[3] = "swBTC";
