...
contract DeployOrkiSwellchain is DeployOrkiBase {
    ...
    address multisig = address(0x7bBC892828f01c79d6b5FFcfb637be32FE01D1BE);
    address interestRouter = address(0x6c6739251d35f88aDe886eEF5Db439d0129CA61a);
    ...
    function run() external {
        ...
        r.collateralRegistry.setInterestRouter(0,interestRouter);
        r.collateralRegistry.setInterestRouter(1,interestRouter);
        r.collateralRegistry.setInterestRouter(2,interestRouter);
        r.collateralRegistry.setInterestRouter(3,interestRouter);
        r.collateralRegistry.setInterestRouter(4,interestRouter);
