...
import {QuillSequencerSentinel} from "src/Quill/SequencerSentinel/Swellchain.sol";

abstract contract DeployOrkiBase is Script, StdCheats, MetadataDeployment {
    using Strings for *;
    using StringFormatting for *;

    address constant WETH_CA = 0x4200000000000000000000000000000000000006;
    address constant WEETH_CA = 0xA6cB988942610f6731e664379D15fFcfBf282b44; // Wrapped eETH weETH
    address constant RSWETH_CA = 0x18d33689AE5d02649a859A1CF16c9f0563975258; // rswETH rswETH
    address constant EZETH_CA = 0x2416092f143378750bb29b79eD961ab195CcEea5; // Renzo Restaked ETH ezETH
    address constant RSETH_CA = 0xc3eACf0612346366Db554C991D7858716db09f58; // KelpDao Restaked ETH rsETH
    address constant SWETH_CA = 0x09341022ea237a4DB1644DE7CCf8FA0e489D85B7; // swETH
    address constant SWBTC_CA = 0x1cf7b5f266A0F39d6f9408B90340E3E71dF8BF7B; // 8 DECIMALS / NO ORACLE
    address constant USDC_CA = 0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34; // THIS IS USDe
    address constant SWELL_CA = 0x2826D136F5630adA89C1678b64A61620Aab77Aea;

    uint256 constant INITIAL_TROVE_CCR_MARGIN = 102 * _1pct;
    uint256 constant WETH_BORROW_CAP = 1_500_000 ether;
    uint256 constant WEETH_BORROW_CAP = 1_000_000 ether;
    uint256 constant RSWETH_BORROW_CAP = 1_000_000 ether;
    uint256 constant EZETH_BORROW_CAP = 1_000_000 ether;
    uint256 constant RSETH_BORROW_CAP = 1_000_000 ether;
    uint256 constant SWETH_BORROW_CAP = 1_500_000 ether;
    uint256 constant SWBTC_BORROW_CAP = 1_000_000 ether;
    uint256 constant SWELL_BORROW_CAP = 500_000 ether;
