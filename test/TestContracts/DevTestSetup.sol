...
contract DevTestSetup is BaseTest {
    ...
    function setUp() public virtual {
        ...
        TestDeployer.DeployedContracts memory deploy = deployer.deployAndConnectContracts();
        ...
        quillAccessManager = deploy.quillAccessManager;
        multiTroveGetter = deploy.multiTroveGetter;
    ...
    function _redeemAndCreateEmptyZombieTrovesAAndB(ABCDEF memory _troveIDs) internal {
        // Redeem enough to leave A with 0 debt and B with debt < troveManager.MIN_DEBT()
        uint256 redeemFromA = troveManager.getTroveEntireDebt(_troveIDs.A);
