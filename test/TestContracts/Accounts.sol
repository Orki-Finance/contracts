...
contract TestAccounts is Test {
    ...
    function createAccounts() public {
        ...
        vm.label(tempAccounts[0], "userA");
        vm.label(tempAccounts[1], "userB");
        vm.label(tempAccounts[2], "userC");
        vm.label(tempAccounts[3], "userD");
        vm.label(tempAccounts[4], "userE");
        vm.label(tempAccounts[5], "userF");
        vm.label(tempAccounts[6], "userG");
    }
}
