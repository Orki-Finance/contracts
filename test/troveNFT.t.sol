...
contract troveNFTTest is DevTestSetup {
    uint256 NUM_COLLATERALS = 8;
    uint256 NUM_VARIANTS = 4;
    TestDeployer.LiquityContractsDev[] public contractsArray;
    TroveNFT troveNFTWETH;
    TroveNFT troveNFTezETH;
    TroveNFT troveNFTWEETH;
    TroveNFT troveNFTrswETH;
    TroveNFT troveNFTrsETH;
    TroveNFT troveNFTswETH;
    TroveNFT troveNFTswBTC;
    TroveNFT troveNFTSWELL;
    uint256[] troveIds;
    ...
    function setUp() public override {
        ...
        troveManagerParamsArray[3] =
            TestDeployer.TroveManagerParams(160e16, 120e16, 120e16, 10e16, 5e16, 10e16, 2000e18, 72e16, _1pct / 2);
        troveManagerParamsArray[4] =
            TestDeployer.TroveManagerParams(160e16, 120e16, 120e16, 10e16, 5e16, 10e16, 2000e18, 72e16, _1pct / 2);
        troveManagerParamsArray[5] =
            TestDeployer.TroveManagerParams(160e16, 120e16, 120e16, 10e16, 5e16, 10e16, 2000e18, 72e16, _1pct / 2);
        troveManagerParamsArray[6] =
            TestDeployer.TroveManagerParams(160e16, 120e16, 120e16, 10e16, 5e16, 10e16, 2000e18, 72e16, _1pct / 2);
        troveManagerParamsArray[7] =
            TestDeployer.TroveManagerParams(160e16, 120e16, 120e16, 10e16, 5e16, 10e16, 2000e18, 72e16, _1pct / 2);

        QuillTestDeployer deployer = new QuillTestDeployer();
        TestDeployer.LiquityContractsDev[] memory _contractsArray;
        TestDeployer.DeployedContractsMultiColl memory deploy =
            deployer.deployAndConnectContractsMultiColl(troveManagerParamsArray);
        _contractsArray = deploy.contractsArray;
        collateralRegistry = deploy.collateralRegistry;
        boldToken = deploy.boldToken;
        WETH = deploy.WETH;
        ...
        contractsArray[3].priceFeed.setPrice(20000e18);
        contractsArray[4].priceFeed.setPrice(20000e18);
        contractsArray[5].priceFeed.setPrice(20000e18);
        contractsArray[6].priceFeed.setPrice(20000e18);
        contractsArray[7].priceFeed.setPrice(20000e18);
        // Just in case
        ...
        // 3 = ezeth
        openMulticollateralTroveNoHints100pctWithIndex(3, A, 0, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(3, A, 1, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(3, A, 2, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(3, A, 10, 100e18, 10000e18, 5e16);

        // 4 = rseth
        openMulticollateralTroveNoHints100pctWithIndex(4, A, 0, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(4, A, 1, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(4, A, 2, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(4, A, 10, 100e18, 10000e18, 5e16);

        // 5 = sweth
        openMulticollateralTroveNoHints100pctWithIndex(5, A, 0, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(5, A, 1, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(5, A, 2, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(5, A, 10, 100e18, 10000e18, 5e16);

        // 6 = swbtc
        openMulticollateralTroveNoHints100pctWithIndex(6, A, 0, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(6, A, 1, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(6, A, 2, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(6, A, 10, 100e18, 10000e18, 5e16);

        // 7 = swell
        openMulticollateralTroveNoHints100pctWithIndex(7, A, 0, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(7, A, 1, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(7, A, 2, 100e18, 10000e18, 5e16);
        openMulticollateralTroveNoHints100pctWithIndex(7, A, 10, 100e18, 10000e18, 5e16);

        troveNFTWETH = TroveNFT(address(contractsArray[0].troveManager.troveNFT()));
        troveNFTWEETH = TroveNFT(address(contractsArray[1].troveManager.troveNFT()));
        troveNFTrswETH = TroveNFT(address(contractsArray[2].troveManager.troveNFT()));
        troveNFTezETH = TroveNFT(address(contractsArray[3].troveManager.troveNFT()));
        troveNFTrsETH = TroveNFT(address(contractsArray[4].troveManager.troveNFT()));
        troveNFTswETH = TroveNFT(address(contractsArray[5].troveManager.troveNFT()));
        troveNFTswBTC = TroveNFT(address(contractsArray[6].troveManager.troveNFT()));
        troveNFTSWELL = TroveNFT(address(contractsArray[7].troveManager.troveNFT()));
    }

    function testTroveNFTMetadata() public view {
        assertEq(troveNFTWETH.name(), "Orki Trove - Wrapped Ether Tester", "Invalid Trove Name");
        assertEq(troveNFTWETH.symbol(), "OT_WETH", "Invalid Trove Symbol");

        assertEq(troveNFTrswETH.name(), "Orki Trove - rswETH", "Invalid Trove Name");
        assertEq(troveNFTrswETH.symbol(), "OT_rswETH", "Invalid Trove Symbol");

        assertEq(troveNFTWEETH.name(), "Orki Trove - Wrapped eETH", "Invalid Trove Name");
        assertEq(troveNFTWEETH.symbol(), "OT_weETH", "Invalid Trove Symbol");

        assertEq(troveNFTezETH.name(), "Orki Trove - Renzo Restaked ETH", "Invalid Trove Name");
        assertEq(troveNFTezETH.symbol(), "OT_ezETH", "Invalid Trove Symbol");
    }
    ...
    function testTroveURIFiles() public {
        ...
        for (uint256 i = 0; i < NUM_VARIANTS; i++) {
            ...
            uris[i + (NUM_VARIANTS)] = troveNFTWEETH.tokenURI(troveIds[i]);
            uris[i + (NUM_VARIANTS * 2)] = troveNFTrswETH.tokenURI(troveIds[i]);
            uris[i + (NUM_VARIANTS * 3)] = troveNFTezETH.tokenURI(troveIds[i]);
            uris[i + (NUM_VARIANTS * 4)] = troveNFTrsETH.tokenURI(troveIds[i]);
            uris[i + (NUM_VARIANTS * 5)] = troveNFTswETH.tokenURI(troveIds[i]);
            uris[i + (NUM_VARIANTS * 6)] = troveNFTSWELL.tokenURI(troveIds[i]);
            uris[i + (NUM_VARIANTS * 7)] = troveNFTswBTC.tokenURI(troveIds[i]);
        }
