...
contract ZapperGasCompTest is DevTestSetup {
    function setUp() public override {
        ...
        TestDeployer.DeployedContractsMultiColl memory deploys =
            deployer.deployAndConnectContracts(troveManagerParams, WETH);
        contractsArray = deploys.contractsArray;
        collateralRegistry = deploys.collateralRegistry;
        boldToken = deploys.boldToken;
        zappersArray = deploys.zappersArray;
    ...
    function testCanNotAddReceiverWithoutRemoveManager() external {
        ...
        IZapper.OpenTroveParams memory params = IZapper.OpenTroveParams({
            ...
            upperHint: 0,
            lowerHint: 0,
            annualInterestRate: troveManager.minAnnualInterestRate(),
            batchManager: address(0),
            maxUpfrontFee: 1000e18,
            addManager: address(0),
            removeManager: address(0),
    ...
    function testCannotCloseTroveIfZapperIsNotReceiver() external {
        ...
        borrowerOperations.openTrove(
            ...
            0, // _upperHint
            0, // _lowerHint
            troveManager.minAnnualInterestRate(), // annualInterestRate,
            10000e18, // upfrontFee
            address(0),
            address(0),
            address(0)
    ...
    function testExcessRepaymentByAdjustGoesBackToUser() external {
        ...
        assertEq(boldToken.balanceOf(A), boldAmount + mindebt - boldDebtBefore, "BOLD bal mismatch");
