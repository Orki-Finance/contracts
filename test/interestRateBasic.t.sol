...
contract InterestRateBasic is DevTestSetup {
    ...
    function testOpenTroveSetsTroveLastDebtUpdateTimeToNow() public {
        ...
        uint256 ATroveId = openTroveNoHints100pct(A, 2 ether, 2000e18, troveManager.minAnnualInterestRate());
        assertEq(troveManager.getTroveLastDebtUpdateTime(ATroveId), block.timestamp);

        vm.warp(block.timestamp + 1000);
        uint256 BTroveId = openTroveNoHints100pct(B, 2 ether, 2000e18, troveManager.minAnnualInterestRate());
    ...
    function testOpenTroveInsertsToCorrectPositionInSortedList() public {
        ...
        uint256 interestRate_A = troveManager.minAnnualInterestRate();
    ...
    function testAdjustTroveInterestRateSetsCorrectNewRate() public {
        ...
        changeInterestRateNoHints(A, ATroveId, troveManager.minAnnualInterestRate());
        assertEq(troveManager.getTroveAnnualInterestRate(ATroveId), troveManager.minAnnualInterestRate());
    ...
    function testAdjustTroveInterestRateInsertsToCorrectPositionInSortedList() public {
        ...
        changeInterestRateNoHints(C, CTroveId, troveManager.minAnnualInterestRate());
