...
contract LiquidationsLSTTest is DevTestSetup {
    function setUp() public override {
        ...
        TestDeployer.DeployedContracts memory deploys = deployer.deployAndConnectContracts(
            TestDeployer.TroveManagerParams(160e16, 120e16, 1.2 ether, 10e16, 5e16, 10e16, 2000e18, 72e16, _1pct / 2)
        );
        collToken = deploys.contracts.collToken;
        activePool = deploys.contracts.activePool;
        borrowerOperations = deploys.contracts.borrowerOperations;
        collSurplusPool = deploys.contracts.pools.collSurplusPool;
        defaultPool = deploys.contracts.pools.defaultPool;
        gasPool = deploys.contracts.pools.gasPool;
        priceFeed = deploys.contracts.priceFeed;
        sortedTroves = deploys.contracts.sortedTroves;
        stabilityPool = deploys.contracts.stabilityPool;
        troveManager = deploys.contracts.troveManager;
        mockInterestRouter = deploys.contracts.interestRouter;
