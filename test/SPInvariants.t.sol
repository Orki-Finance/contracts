...
abstract contract SPInvariantsBase is Assertions, BaseInvariantTest {
    ...
    function setUp() public override {
        ...
        stabilityPool = deploy.contracts.stabilityPool;

        handler = new SPInvariantsTestHandler(
            SPInvariantsTestHandler.Contracts({
                boldToken: deploy.boldToken,
                borrowerOperations: deploy.contracts.borrowerOperations,
                collateralToken: deploy.contracts.collToken,
                priceFeed: deploy.contracts.priceFeed,
                stabilityPool: deploy.contracts.stabilityPool,
                troveManager: deploy.contracts.troveManager,
                collSurplusPool: deploy.contracts.pools.collSurplusPool
            }),
            deploy.hintHelpers
        );
