...
contract SortedTrovesTest is Test {
    ...
    function setUp() public {
        QuillAccessManagerUpgradeable quillAccessManager = QuillAccessManagerUpgradeable(
        ...
        AddressesRegistry addressesRegistry = new AddressesRegistry(address(quillAccessManager), 5e16, 10e16);
