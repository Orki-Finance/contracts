...
contract BasicOps is DevTestSetup {
    function testOpenTroveFailsWithoutAllowance() public {
        ...
        borrowerOperations.openTrove(
            G, 0, 2e18, 2000e18, 0, 0, minInterestRate, 1000e18, address(0), address(0), address(0)
        );
        vm.stopPrank();
    }
    ...
    function testLiquidation() public {
        ...
        vm.startPrank(A);
        uint256 A_Id = borrowerOperations.openTrove(
            A, 0, 2e18, 2200e18, 0, 0, troveManager.minAnnualInterestRate(), 1000e18, address(0), address(0), address(0)
        );
        vm.stopPrank();
