...
contract SPTest is DevTestSetup {
    ...
    function testGetDepositorBoldGain_1SPDepositor1RewardEvent_EarnsAllSPYield() public {
        ...
        uint256 pendingAggInterest = activePool.calcPendingAggInterest();
        assertGt(pendingAggInterest, 0);
        uint256 expectedSpYield = activePool.stabilityPoolYieldSplit() * pendingAggInterest / 1e18;
    ...
    function testGetDepositorBoldGain_1SPDepositor2RewardEvent_EarnsAllSPYield() public {
        ...
        uint256 expectedSpYield_1 = activePool.stabilityPoolYieldSplit() * pendingAggInterest_1 / 1e18;
        ...
        uint256 expectedSpYield_2 = activePool.stabilityPoolYieldSplit() * pendingAggInterest_2 / 1e18;
    ...
    function testGetDepositorBoldGain_2SPDepositor1LiqFreshDeposit_EarnFairShareOfSPYield() public {
        ...
        uint256 expectedSpYield_0 = activePool.stabilityPoolYieldSplit() * pendingAggInterest_0 / 1e18;
    ...
    function testGetDepositorBoldGain_2SPDepositor2LiqScaleChangesFreshDeposit_EarnFairShareOfSPYield() public {
        ...
        expectedSpYield[0] = activePool.stabilityPoolYieldSplit() * pendingAggInterest[0] / 1e18;
        ...
        expectedSpYield[1] = activePool.stabilityPoolYieldSplit() * (pendingAggInterest[1] + upfrontFee_E) / 1e18;
        ...
        expectedSpYield[2] = activePool.stabilityPoolYieldSplit() * pendingAggInterest[2] / 1e18;
    ...
    function testLiquidationsWithLowPAllowFurtherRewardsForAllFreshDepositors_Cheat_Fuzz(
        ...
        uint256 pendingAggInterest = activePool.calcPendingAggInterest();
        assertGt(pendingAggInterest, 0);
        testVars.expectedSpYield1 = activePool.stabilityPoolYieldSplit() * pendingAggInterest / 1e18;
        ...
        uint256 expectedSpYield2 = activePool.stabilityPoolYieldSplit() * pendingAggInterest2 / 1e18;
        ...
        public
    {
        ...
        uint256 expectedSpYield1 = activePool.stabilityPoolYieldSplit() * pendingAggInterest1 / 1e18;
    ...
    function testLiqDebtWithin1BoldOfTotalDepositsSplitsCollGainsCorrectly_Fuzz() public {
        ...
        assertEq(collToken.balanceOf(C), vars.collCBefore + vars.collGasComp + 0.005 ether, "Incorrect coll increase C");
    ...
    function testLiqDebtGreaterThanTotalSSplitsCollGainsCorrectly_Fuzz(uint256 _toRedist) public {
        ...
        // Check C's total WETH balance increased by the total gas comp
        assertEq(collToken.balanceOf(C), vars.collCBefore + vars.collGasComp + 0.005 ether);
