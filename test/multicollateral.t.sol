...
contract MulticollateralTest is DevTestSetup {
    ...
    function setUp() public override {
        ...
        troveManagerParamsArray[3] =
            TestDeployer.TroveManagerParams(160e16, 125e16, 125e16, 10e16, 5e16, 10e16, 2000e18, 72e16, _1pct / 2);
    ...
    function testMultiCollateralDeployment() public {
        ...
        for (uint256 c = NUM_COLLATERALS; c < MAX_NUMBER_COLLATERALS; c++) {
            vm.expectRevert(abi.encodeWithSelector(CollateralRegistry.InvalidIndex.selector, c));
        ...
        vm.expectRevert(abi.encodeWithSelector(CollateralRegistry.InvalidIndex.selector, 10));
...
contract CsBold013 is TestAccounts {
    ...
    function setUp() external {
        ...
        _branches = deploy.contractsArray;
        collateralRegistry = deploy.collateralRegistry;
        boldToken = deploy.boldToken;
        weth = deploy.WETH;
        hintHelpers = deploy.hintHelpers;
    ...
    function test_WontRedeemMoreThanTotalUnbacked_UnlessTotalUnbackedIsZero() external {
        // ETH branch setup
        {
            openTroveWithExactICRAndDebt(0, A, 0, CCR_WETH, 200_000 ether, branches[0].troveManager.minAnnualInterestRate());
        ...
        // wstETH branch setup
        {
            openTroveWithExactICRAndDebt(1, A, 0, 2 * CCR_WETH, 100_000 ether, branches[1].troveManager.minAnnualInterestRate());
        ...
        // rETH branch setup
        {
            openTroveWithExactICRAndDebt(2, A, 0, 2 * CCR_WETH, 10_000 ether, branches[2].troveManager.minAnnualInterestRate());
