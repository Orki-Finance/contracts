...
contract ShutdownTest is DevTestSetup {
    ...
    function _getSPYieldHelper(uint256 _aggInterest, uint256 split) internal pure returns (uint256) {
        uint256 spYield = split * _aggInterest / 1e18;
        assertGt(spYield, 0);
    ...
    function testShutdownZerosMintsPendingAggInterestToSP() public {
        ...
        uint256 expectedSPYield =
            _getSPYieldHelper(accruedAggInterest, contractsArray[0].activePool.stabilityPoolYieldSplit());
