...
interface IAddressesRegistry is IAccessManaged {
    struct AddressVars {
    ...
    function stabilityPoolYieldSplit() external returns (uint256);
    ...
    function sequencerSentinel() external view returns (ISequencerSentinel);
