...
library bauhaus {
    string constant ORANGE = "#FFFF82";
    string constant ORANGE_MEDIUM = "#FF8360";
    string constant GREEN_MINT = "#CA7DF9";
    string constant ORANGE_LIGHT = "#3AFFA7";
    string constant BLUE = "#47F3FF";
    string constant BLACK = "#2973EB";
    string constant BROWN = "#6FABAC";
    ...
    function _bauhaus(string memory _collName, uint256 _troveId) internal pure returns (string memory) {
        ...
        if (collSig == keccak256("WETH") || collSig == keccak256("rswETH")) {
            return _img1(variant);
        } else if (collSig == keccak256("swBTC") || collSig == keccak256("swETH")) {
    ...
    function _colorCode2Hex(colorCode _color) private pure returns (string memory) {
        if (_color == colorCode.ORANGE) {
            return ORANGE;
        } else if (_color == colorCode.ORANGE_MEDIUM) {
            return ORANGE_MEDIUM;
        } else if (_color == colorCode.GREEN_MINT) {
            return GREEN_MINT;
        } else if (_color == colorCode.ORANGE_LIGHT) {
            return ORANGE_LIGHT;
        } else if (_color == colorCode.BLUE) {
            return BLUE;
        } else if (_color == colorCode.BLACK) {
            return BLACK;
        } else {
            return BROWN;
        }
    ...
    function _colors1(uint256 _variant) internal pure returns (COLORS memory) {
        if (_variant == 0) {
            return COLORS(
                ...
                colorCode.ORANGE, // rect2
                colorCode.ORANGE, // rect3
                colorCode.BROWN, // rect4
                colorCode.ORANGE_MEDIUM, // rect5
                colorCode.ORANGE_LIGHT, // poly
                colorCode.GREEN_MINT, // circle1
                colorCode.BLACK, // circle2
                colorCode.ORANGE // circle3
            );
        } else if (_variant == 1) {
            return COLORS(
                colorCode.GREEN_MINT, // rect1
                colorCode.BLUE, // rect2
                colorCode.ORANGE, // rect3
                colorCode.BROWN, // rect4
                colorCode.ORANGE, // rect5
                colorCode.ORANGE_MEDIUM, // poly
            ...
            return COLORS(
                colorCode.BLUE, // rect1
                colorCode.ORANGE, // rect2
                colorCode.ORANGE_LIGHT, // rect3
                colorCode.ORANGE, // rect4
                colorCode.BROWN, // rect5
                colorCode.GREEN_MINT, // poly
                colorCode.ORANGE_MEDIUM, // circle1
                colorCode.BLACK, // circle2
                colorCode.BROWN // circle3
            );
        } else {
            return COLORS(
                colorCode.ORANGE_LIGHT, // rect1
                colorCode.BLUE, // rect2
                colorCode.BLUE, // rect3
                colorCode.BROWN, // rect4
                colorCode.BLUE, // rect5
                colorCode.GREEN_MINT, // poly
                colorCode.ORANGE, // circle1
                colorCode.BLACK, // circle2
                colorCode.BLUE // circle3
            );
        }
    ...
    function _colors2(uint256 _variant) internal pure returns (COLORS memory) {
        if (_variant == 0) {
            return COLORS(
                ...
                colorCode.ORANGE, // rect2
                colorCode.BLUE, // rect3
                colorCode.GREEN_MINT, // rect4
                colorCode.ORANGE_MEDIUM, // rect5
                colorCode.ORANGE, // unused
                colorCode.ORANGE, // circle1
                colorCode.ORANGE_LIGHT, // circle2
                colorCode.GREEN_MINT // circle3
            );
        } else if (_variant == 1) {
            return COLORS(
                colorCode.GREEN_MINT, // rect1
                ...
                colorCode.ORANGE_LIGHT, // rect5
                colorCode.ORANGE, // unused
                colorCode.GREEN_MINT, // circle1
                colorCode.ORANGE_MEDIUM, // circle2
                colorCode.BLUE // circle3
            );
        } else if (_variant == 2) {
            return COLORS(
                colorCode.BLUE, // rect1
                colorCode.ORANGE, // rect2
                colorCode.GREEN_MINT, // rect3
                colorCode.BLUE, // rect4
                colorCode.ORANGE_MEDIUM, // rect5
                colorCode.ORANGE, // unused
                colorCode.ORANGE_LIGHT, // circle1
                colorCode.BROWN, // circle2
                colorCode.BROWN // circle3
            );
        } else {
            return COLORS(
                colorCode.ORANGE, // rect1
                colorCode.GREEN_MINT, // rect2
                colorCode.BLUE, // rect3
                colorCode.ORANGE, // rect4
                colorCode.BROWN, // rect5
                colorCode.ORANGE, // unused
                ...
                colorCode.ORANGE_LIGHT, // circle2
                colorCode.ORANGE_MEDIUM // circle3
            );
        }
    }
    ...
    function _colors3(uint256 _variant) internal pure returns (COLORS memory) {
        if (_variant == 0) {
            ...
            return COLORS(
                ...
                colorCode.ORANGE_LIGHT // circle3
            );
        } else if (_variant == 2) {
            return COLORS(
                colorCode.ORANGE_MEDIUM, // rect1
                colorCode.ORANGE_LIGHT, // rect2
                colorCode.ORANGE_MEDIUM, // rect3
                colorCode.ORANGE, // rect4
                colorCode.ORANGE, // unused
                colorCode.ORANGE, // unused
                colorCode.GREEN_MINT, // circle1
